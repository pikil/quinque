import{c as y}from"./objects.iCGkf26S.js";import{r as u}from"./scheduler.tTzP0KDC.js";function g(t,{delay:o=0,duration:s=400,easing:c=u}={}){const n=+getComputedStyle(t).opacity;return{delay:o,duration:s,easing:c,css:r=>`opacity: ${r*n}`}}function C(t,{delay:o=0,duration:s=400,easing:c=y,start:n=0,opacity:r=0}={}){const a=getComputedStyle(t),e=+a.opacity,f=a.transform==="none"?"":a.transform,m=1-n,p=e*(1-r);return{delay:o,duration:s,easing:c,css:(d,i)=>`
